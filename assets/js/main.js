...
$(function () {
    ...
    ***************************/
    const options = {
        ...
        linkSelector: 'a:not([data-no-swup]):not([target="_blank"]):not([href^="http"])',
    ...
    ***************************/
    ...
    timeline.fromTo(
        ...
        { y: "30px", opacity: 0 },
        { y: "0px", opacity: 1, stagger: 1 }
    );

    // Fade out Animation 1 before showing Animation 2
    ...
    // Fade out Animation 2 before showing Animation 3
    ...
    // Show Animation 3
    timeline.fromTo(
        ".mil-animation-3 .mil-h3",
        { y: "30px", opacity: 0 },
        { y: "0px", opacity: 1, stagger: 1 }
    );

    // Fade out Animation 3
    timeline.to(".mil-animation-3 .mil-h3", 0.6, {
        opacity: 0,
        y: "-30"
    }, "+=.5");

    // Fade out preloader and show the main content
